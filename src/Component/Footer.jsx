        ...
        <div className="row mb-1">
          <div className="col-lg-2">
            <div className="ftco-footer-widget mb-4">
              <h2 className="ftco-heading-2">Ojishop</h2>
          ...
          <div className="col-lg-4">
            <div className="ftco-footer-widget mb-4">
            	...
            	<div className="block-23 mb-3">
	              <ul>
	                <li><span className="icon icon-map-marker"></span><span className="text">C-31, Gijhore Rd, Block B, Sector 53, Noida, Uttar Pradesh 201301</span></li>
	                <li><Link to="#"><span className="icon icon-phone"></span><span className="text">+91 9142875785</span></Link></li>
	                <li><Link to="#"><span className="icon icon-envelope"></span><span className="text">sonu91428singh@gmail.com</span></Link></li>
	              </ul>
	            </div>
            </div>
          </div>
