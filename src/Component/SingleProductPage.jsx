          ...
          <div className="row">
            ...
            <div className="col-lg-6 product-details pl-md-5 ">
              ...
              <div className="d-flex">
                <button
                  onClick={addToCart}
                  className="btn btn-secondary w-50 w-50 mr-2"
                >
                  Add to Cart
                </button>
                <button
